...
<div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 px-4">
  <div className="flex max-h-[99dvh] w-full max-w-[420px] flex-col overflow-hidden rounded-[22px] bg-white">
        {/* Header */}
        ...
        <div className="flex flex-col max-h-[300px] overflow-y-auto gap-2 p-4 pt-0">
          <div className="h-[130px] w-full bg-red-200 rounded rounded-t-none">
            <img
              src={product.image}
