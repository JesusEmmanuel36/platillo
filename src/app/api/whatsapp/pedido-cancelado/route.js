...
export async function POST(req) {
  ...
  try {
    ...
    const { orderId, razonCancelacion } = await req.json();
    ...
    const telefonoRestaurante = restaurant.phone || "el restaurante";
    const motivo = razonCancelacion || "No especificado";
